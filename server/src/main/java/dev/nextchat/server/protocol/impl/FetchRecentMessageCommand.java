...
public class FetchRecentMessageCommand implements Command {
    private final UUID groupId;
    private final MessageService messageService;
    private final GroupService groupService;

    public FetchRecentMessageCommand(UUID groupId, MessageService messageService, GroupService groupService) {
    ...
    public JSONObject execute(CommandContext context) {
        ...
        List<Message> messages = messageService.findRecentMessages(groupId);
