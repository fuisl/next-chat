...
public class SearchMessagesCommand implements Command {
    private final UUID groupId;
    private final String keyword;
    private final MessageService messageService;
    private final GroupService groupService;

    public SearchMessagesCommand(UUID groupId, String keyword, MessageService messageService, GroupService groupService) {
    ...
    public JSONObject execute(CommandContext context) {
        ...
        response.put("type", "search_message_response");
        ...
        List<Message> messages = messageService.searchMessages(groupId, keyword);
